...
@interface TWGuanZhuViewController ()<UIAlertViewDelegate>

@end

@implementation TWGuanZhuViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [cancelBtn setTitle:@"已关注" forState:UIControlStateNormal];
    ...
    cancelBtn.frame = CGRectMake(TWScreenW - 55, 25, 45, 20);
